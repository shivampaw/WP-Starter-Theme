...
if ( ! function_exists( 'shivampaw_setup' ) ) :
	...
	function shivampaw_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'shivampaw_custom_background_args', [
...
function shivampaw_scripts() {
	...
	wp_enqueue_script( 'jquery-tether', get_template_directory_uri() . '/js/dist/jquery.tether.min.js', [ 'jquery' ] );
...
function shivampaw_bootstrap_pagination( $echo = true ) {
	...
	$pages = paginate_links( [
		                         ...
		                         'type'      => 'array',
		                         'prev_next' => true,
		                         'prev_text' => __( 'Prev', 'shivampaw' ),
		                         'next_text' => __( 'Next', 'shivampaw' ),
	                         ]
	);
